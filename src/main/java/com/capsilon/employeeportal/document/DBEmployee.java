...
public class DBEmployee extends DBRecord
{
	...
	private boolean haveValidPassport;
	...
	public String getCurrent_PIN_Code() {
		return current_PIN_Code;
	}

	public void setCurrent_PIN_Code(String current_PIN_Code) {
		this.current_PIN_Code = current_PIN_Code;
	}
	...
	public String getPermanent_PIN_Code() {
		return permanent_PIN_Code;
	}

	public void setPermanent_PIN_Code(String permanent_PIN_Code) {
	...
	public void setHavepassport(boolean havepassport) {
		this.haveValidPassport = havepassport;
	}
